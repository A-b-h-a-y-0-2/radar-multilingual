...
args = get_args()
PRE_TRAINED_MODEL_NAME = 'TrustSafeAI/RADAR-Vicuna-7B'
model_name = PRE_TRAINED_MODEL_NAME.split('/')[-1]
dataset = args.language #'en', 'es', 'ru', 'all', 'en3'
generative_model = args.model #'text-davinci-003', 'gpt-3.5-turbo', 'gpt-4', 'llama-65b', 'opt-66b', 'opt-iml-max-1.3b', 'all'
